...
function ScrollToTopButton() {
  ...
  return (
    <button
      className={`up-btn fixed bottom-6 right-6 z-50 hover:bg-black text-white rounded-full cursor-pointer transition-all duration-300 w-14 h-14 flex justify-center items-center ${
